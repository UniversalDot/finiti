                ...
                <Col xs={12}>
                    <div className="d-flex align-items-lg-center flex-lg-row flex-column">
                        <div className="flex-grow-1">
                            <h4 className="fs-16 mb-1">Welcome to Finity Analytics</h4>
                            <p className="text-muted mb-0">Here's what's happening with the world of decentralized networks today.</p>
                        </div>
